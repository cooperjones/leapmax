...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 665.0, 424.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1056.0, 498.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 795.0, 462.699951, 61.0, 22.0 ],
					"style" : "",
					"text" : "s location"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 332.0, 461.0, 31.0, 22.0 ],
									"style" : "",
									"text" : "+ 1."
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 332.0, 362.0, 50.0, 22.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 414.0, 517.0, 50.0, 22.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 332.0, 394.0, 31.0, 22.0 ],
									"style" : "",
									"text" : "!/ 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "int" ],
									"patching_rect" : [ 341.0, 285.0, 30.0, 22.0 ],
									"style" : "",
									"text" : "t b i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 332.0, 329.0, 39.0, 22.0 ],
									"style" : "",
									"text" : "zl.nth"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 332.0, 523.0, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 352.0, 160.0, 24.0, 24.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 286.0, 145.0, 29.5, 22.0 ],
									"style" : "",
									"text" : "1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 263.0, 174.0, 42.0, 22.0 ],
									"style" : "",
									"text" : "zl.sub"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 263.0, 206.0, 63.0, 22.0 ],
									"style" : "",
									"text" : "zl.group 5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 180.0, 240.0, 146.0, 22.0 ],
									"style" : "",
									"text" : "5 8 12"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 26.0, 100.0, 24.0, 24.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 67.0, 90.0, 57.0, 22.0 ],
									"style" : "",
									"text" : "getrow 0"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 352.0, 240.0, 50.0, 22.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 509.0, 58.0, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "int", "", "", "int" ],
									"patching_rect" : [ 352.0, 205.0, 71.0, 22.0 ],
									"style" : "",
									"text" : "counter 1 3"
								}
...
, 							{
								"box" : 								{
									...
									"parameter_enable" : 0,
									"patching_rect" : [ 67.0, 118.0, 215.0, 22.0 ],
									"rows" : 1,
									"style" : ""
								}
...
,
					"patching_rect" : [ 1032.0, 455.799988, 82.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 830.43335, 253.099976, 256.0, 64.0 ],
					"setmode" : 1,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					"addpoints" : [ 0.0, 0.0, 0, 0.630743, 1.0, 0, 1.0, 0.0, 0 ],
					"domain" : 1.0,
					"id" : "obj-106",
					"maxclass" : "function",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 677.93335, 582.899963, 169.0, 22.0 ],
					"style" : "",
					"text" : "poly~ polygrangrain_chord 25"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 982.13335, 438.600037, 753.83335, 438.600037 ],
					"order" : 1,
					"source" : [ "obj-3", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 934.73335, 350.200012, 909.200012, 350.200012, 909.200012, 421.400024, 737.23335, 421.400024 ],
					"order" : 1,
					"source" : [ "obj-3", 2 ]
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "polygrangrain_chord.maxpat",
